...
@Component({
    ...
    styleUrls: ['./x-transfer.component.less'],
...
export class XTransferComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.sSearchValue.valueChanges.pipe(debounceTime(500)).subscribe(result => {
            this.sSearchChange.emit(result);
        });
        this.dSearchValue.valueChanges.pipe(debounceTime(500)).subscribe(result => {
